...
// +kubebuilder:rbac:groups=webapp.prasad.mukta,resources=guestbooks,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=webapp.prasad.mukta,resources=guestbooks/status,verbs=get;update;patch
